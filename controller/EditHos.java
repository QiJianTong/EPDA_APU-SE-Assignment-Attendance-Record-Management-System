 ...
 * @author 91310
 */
@WebServlet(name = "EditHos", urlPatterns = {"/EditHos"})
public class EditHos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("hosprofile.jsp").forward(request, response);
        try (PrintWriter out = response.getWriter()) {
            out.print("success!");  
            request.getRequestDispatcher("hosprofile.jsp").include(request, response);
